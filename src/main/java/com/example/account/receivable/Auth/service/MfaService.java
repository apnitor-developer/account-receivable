...
import com.example.account.receivable.Auth.dto.MfaSetupResponseDto;
...
public class MfaService {
    ...
    @Value("${app.mfa.app-name:Account Receivable}")
    ...
    private String buildOtpAuthUrl(String name, String secret) {
        String label = URLEncoder.encode(name, StandardCharsets.UTF_8);
